...
const relayCommand = mode === 'dsh'
  ...
  : mode === 'codex' ? `${runtimeEnvironment} pnpm exec tsx scripts/codex-host-fixture.ts`
...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'webkit-mobile-viewport', testMatch: ['mobile-viewport.spec.ts', 'layout-diagnostics.spec.ts'], use: { ...devices['iPhone 13'], browserName: 'webkit' } },
  ],
  webServer: [
    {
      command: relayCommand,
      url: `http://127.0.0.1:${relayPort}/v1/providers?protocolVersion=1.5.0`,
