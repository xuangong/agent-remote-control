...
const tracking: SessionTracking = { reorder: vi.fn(), reconcileFavorites: vi.fn(), rename: vi.fn(), replace: vi.fn(), sessions: [], backgroundSessions: [], observations: {}, observers: [], error: undefined, toggle: vi.fn(), retry: vi.fn(), acknowledge: vi.fn() };
