...
export function PreviewBrowser({ url, target, error, returnFocus, onClose }: {
...
function BrowserIcon({ name }: { readonly name: 'back' | 'forward' | 'reload' | 'close' | 'expand' | 'restore' }) {
  const paths = { back: 'm14 5-7 7 7 7', forward: 'm10 5 7 7-7 7', close: 'm6 6 12 12M18 6 6 18',
