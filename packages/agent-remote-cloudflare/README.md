...
```sh
pnpm build:relay
pnpm --filter @borgee/agent-remote-cloudflare build
pnpm --filter @borgee/agent-remote-cloudflare typecheck
pnpm test:cloudflare
pnpm --filter @borgee/agent-remote-cloudflare deploy:dry-run
```
