...
export const ExecuteCommandRequest = Strict({ protocolVersion: ProtocolVersionSchema, type: Type.Literal('execute_command'), payload: Strict({ ...Identity, commandId: NonEmptyString, args: Type.String() }) });
