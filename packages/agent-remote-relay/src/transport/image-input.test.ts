...
import { IMAGE_INPUT_CAPABILITIES, type AgentInputPart, type AgentProviderAdapter } from '@agent-remote-controller/agent-provider-sdk';
import { PROTOCOL_VERSION, type ServerMessage } from '@agent-remote-controller/agent-remote-protocol';
