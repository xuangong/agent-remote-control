...
export function ReplayView({ name: initialName, recording: initialRecording }: { name: string; recording: SessionRecording }) {
  ...
  return <ToastProvider><main className="ardb-replay">
    ...
    <div className="ardb-replay-session"><ReplaySession key={revision} state={player.state} status={player.status} /></div>
  </main></ToastProvider>;
}
