...
it('confirms native rename before updating favorites and broadcasts the same identity to other devices', async () => {
  ...
  const identity = { hostId, providerId: 'codex', nativeSessionId: 'native' };
  ...
  const payload = { providerId: 'codex', nativeSessionId: 'native', title: 'Renamed', operationId: 'c1403532-9dd9-4b0e-9938-d57241cbb96d' };
