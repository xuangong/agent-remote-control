...
import { AgentReplica, HttpWebSocketTransport, RemoteOperationError, type RemoteAgentTransport, type RemoteConnection, type RemoteProtocolObservation, type RemoteTransportDiagnostic, type RemoteTransportListener } from '@borgee/agent-remote-web/headless';

import type { DebuggerRuntime } from './runtime.js';

import { runCli, type CliEnvironment } from './cli.js';

const protocolVersion = '1.1.0' as const;
